...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('paste_snippet', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
        ...
        db.send_create_signal('paste', ['Snippet'])


    def backwards(self, orm):
        
        # Deleting model 'Snippet'
        db.delete_table('paste_snippet')
