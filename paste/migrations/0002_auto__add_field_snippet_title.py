...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('paste_snippet', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Snippet.title'
        db.delete_column('paste_snippet', 'title')
